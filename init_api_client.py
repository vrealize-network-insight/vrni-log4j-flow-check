...
def get_api_client(args):
    if args.deployment_type == "onprem":
        if not args.platform_ip:
            print("Please provide platform_ip of onprem setup !!!")
            sys.exit()
        return get_onprem_api_client(args)
    else:
        if not args.api_token:
            print("Please provide refresh token for VRNIC setup !!!")
            sys.exit()
...
def get_onprem_api_client(args):
    ...
    print("Getting api client for IP <{}>".format(args.platform_ip))
...
def get_vrnic_api_client(args):
    ...
    print("Getting api client for VRNIC")
